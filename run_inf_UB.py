...
if __name__ == "__main__":
    ...
    folder_videos ="/media/pinas/riccardo/UBnormal_video/UB_test/"#"/home/riccardo/STC/shanghaitech/testing/frames"  #"/home/riccardo/Avenue_Dataset/testing_videos/" #   
   
    
    checkpoint_folder = "/home/riccardo/checkpoints_ub"
    
    last_model = get_latest_model_file(checkpoint_folder)
    steps = last_model.split('/')[-1].split('_')[-1].split(".")[0] if last_model else "unknown"
    
    base_output_folder = f"/media/pinas/riccardo/OUT_UB/UB_outputs_{steps}train_200step" #"/media/pinas/riccardo/outputs_620train_200step"  #  Cartella dove creare le sottocartelle
    ...
    for video_number in os.listdir(input_dir):
        ...
        save_video_from_npz(
                ...
                fps=30,
                upsample_size=(1080, 720) #Avenue 640x360 STC 856,480  UB 1080,720 # Imposta la dimensione di upsample desiderata
            )
